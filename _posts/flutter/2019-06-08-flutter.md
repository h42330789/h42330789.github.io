---
title: Flutter几行代码处理点击空白关闭键盘及添加键盘ToolBar
author: 独孤流
date: 2016-06-08 12:12:00 +0800
categories: [flutter]
tags: [flutter]     # TAG names should always be lowercase
---

上一篇：[Flutter解决有输入框的页面，点击非输入框部分自动关闭键盘及键盘相关笔记](https://www.jianshu.com/p/989d677d0403)
> ####前言
...
```
![自定义toolbar.gif](https://upload-images.jianshu.io/upload_images/1605558-ca61cd50c4ba6d77.gif?imageMogr2/auto-orient/strip)


工具类`BlankToolBarTool.dart`
```
import 'ToolBar.dart';
import 'package:flutter/material.dart';
